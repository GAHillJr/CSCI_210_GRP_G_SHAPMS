Project Overview:
SHAPMS is designed to manage hospital data, including patients, doctors, appointments, schedules, and statistics. We applied core computer science concepts such as object-oriented programming, data structures, and testing to simulate a real world hospital management system to this project.

The system allows users to:
- create and manage patient and doctor profiles
- schedule and track patient appointments
- organize data efficiently using appropriate data structures
...
- first&last name, patient ID, age, and birthdate
- contact info
- medical history
- active appointments
...
- cleaner separation between user input and object creation

HospitalDataManager
acts as the central controller of the system and integrates all other classes
- stores patients and doctors using hash tables for fast access
...
- The project intentionally incorporates data structures learned in class:
   ...
   - ArrayList - storage of appointments
   - Set - managing unique specialities and departments
...
- searching and sorting behavior
...
1. Core Logic Improvements
   ...
   - Improved sorting and searching reliability without mutating original data
2. Test Class Development&Fix
   ...
   - ensured all classes passed tests consistently after integration
